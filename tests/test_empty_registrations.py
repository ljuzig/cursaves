...
def _mixed_workspace(sync_env) -> list[dict]:
...
def test_mixed_workspace_status_counts_active_only(sync_env, monkeypatch, capsys):
    _mixed_workspace(sync_env)
...
def test_targeted_sync_all_synced_plus_empty_is_not_local_ahead(
    ...
    actives = _mixed_workspace(sync_env)
